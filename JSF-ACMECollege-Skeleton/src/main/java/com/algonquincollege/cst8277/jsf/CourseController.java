    ...
    public void loadCourses() {
        try {
            ...
            if (response.getStatus() == 200) {
                ...
                facesContext.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Failed to load courses. Status: " + response.getStatus(), null));
            }
        } catch (Exception e) {
            facesContext.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error loading courses: " + e.getMessage(), null));
        }
    }
